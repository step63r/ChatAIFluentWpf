...
{
    /// <summary>
    /// MessageReceivedUserControl.xaml の相互作用ロジック
    /// </summary>
    public partial class MessageReceivedUserControl : UserControl
    {
        #region 依存関係プロパティ
        /// <summary>
        /// メッセージの依存関係プロパティ
        ...
        public static readonly DependencyProperty MessageProperty = DependencyProperty.Register(
            nameof(Message),
            typeof(string),
            typeof(MessageReceivedUserControl),
        ...
        /// コンストラクタ
        /// </summary>
        public MessageReceivedUserControl()
        {
            InitializeComponent();
        }
        #endregion
        ...
        {
            if (sender is MessageReceivedUserControl ctrl)
            {
